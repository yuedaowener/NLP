...
"""
@author: Me
@time: 2021/5/22 14:24
@description: implement of CBOW and skip-gram with pure python,
        ...
        for line in fi:
            ...
            for token in tokens:
                ...
                if word_count % 10000 == 0:
                    ...
                    sys.stdout.flush()  # TODO: 这是什么？这么神奇？
...
class UnigramTable:
    ...
    def __init__(self, vocab):
        ...
        table_size = int(1e3)  # Length of the unigram table
...
def gen_small_data(n_sample=1000):
    fp_in = r"C:\Users\chen_\Desktop\enwik8\enwik8"
    fp_out = r"C:\Users\chen_\Desktop\enwik8\enwik8_small"

    cnt = 0
    with open(fp_in, 'r', encoding='utf8') as f_in, open(fp_out, 'w', encoding='utf-8') as f_out:
        for line in f_in:
...
def main():
    ...
    cbow = 1
    train(fi, fo, cbow, 1, dim=100, alpha=0.025, win=5, min_count=5, num_processes=1, binary=0)
